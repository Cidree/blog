...
::: {.about-links .text-center}
<a href="https://www.linkedin.com/in/adrian-cidre-gonz%C3%A1lez-8a50371b0/" class="about-link btn btn-info" rel="" target="_blank"> <i class="bi bi-linkedin"></i> [LinkedIn]{.about-link-text} </a> <a href="https://github.com/Cidree" class="about-link btn btn-dark" rel="" target="_blank"> <i class="bi bi-github"></i> [Github]{.about-link-text} </a> <a href="mailto:adrian.cidre@gmail.com" class="about-link btn btn-info" rel="" target="_blank"> <i class="bi bi-envelope-at"></i> [Contact me]{.about-link-text} </a>
:::
...
::: {.g-col-12 .g-col-md-6 .d-none .d-sm-block}
### Spain 🏖️
...
My CV was created using the `{vitae}` R package, and you can find with the source code as well the CV in [this repository](https://github.com/Cidree/Curriculum_ACG).
