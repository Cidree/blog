...
For the examples below, I will use the [Burnt Area database](https://forest-fire.emergency.copernicus.eu/applications/data-and-services){target="_blank"} from the EFFIS, which is a database that contains data about the wildfires that happened in Europe from 2016 until the current date (April 2026). I have prepared the data previously, and simplified it for the examples. The data contains six columns:
...
- Buying me a [coffee](https://buymeacoffee.com/adriancidre){target="_blank"}.
