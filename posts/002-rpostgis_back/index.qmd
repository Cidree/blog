...
The package updates haven't been published in the website of the package ([rpostgis](https://mablab.org/rpostgis/)). This is because we am working in the migration of the package to my GitHub repository, and then I will publish the website again probably through GitHub pages or my website. However, the main new features are:
